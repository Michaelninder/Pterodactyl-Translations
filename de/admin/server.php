...
return [
    'exceptions' => [
        ...
        'bad_variable' => 'Es gab einen Fehler beim überprüven der :name Variable.',
        ...
        'default_allocation_not_found' => 'Der angefragte standart Standort wurde nicht in den Addressem des Servers gefunden.',
    ],
    'alerts' => [
        ...
        'server_deleted' => 'Der Server wurde Erfolgreich von diesem Systhhem gelöscht.',
